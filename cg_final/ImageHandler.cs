   ...
   public class ImageHandler
    {
        ...
        public void AdjustBrightnessForColorShade(Color targetColor, int brightness, int tolerance)
        {
            Bitmap temp = (Bitmap)_currentBitmap.Clone();
            Bitmap bmap = new Bitmap(temp.Width, temp.Height);
            ...
            for (int i = 0; i < temp.Width; i++)
            {
                for (int j = 0; j < temp.Height; j++)
                {
                    ...
                    {
                        int r = Math.Min(255, Math.Max(0, c.R + brightness));
                        int g = Math.Min(255, Math.Max(0, c.G + brightness));
                        int b = Math.Min(255, Math.Max(0, c.B + brightness));
        ...
        public void AdjustContrast(float contrast)
        {
            ...
            for (int i = 0; i < temp.Width; i++)
            {
                for (int j = 0; j < temp.Height; j++)
                {
                    ...
                    int r = Math.Min(255, Math.Max(0, (int)pR));
                    int g = Math.Min(255, Math.Max(0, (int)pG));
                    int b = Math.Min(255, Math.Max(0, (int)pB));
                    bmap.SetPixel(i, j, Color.FromArgb(r, g, b));
                }
            }
